                                    ...
                                    <form novalidate method="POST" action="{{ route('register_response') }}">
                                        ...
                                        <div class="row">
                                            <div class="col-sm">
                                                <div class="form-field mb-2">
                                                    <div class="form-field__control">
                                                        <label for="country" name="country" class="form-field__label">Country</label>
                                                        <select id="country" name="country" class="form-field__input">
                                        ...
                                        <div class="row">
                                            <div class="col-sm">
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input mt-1" type="checkbox" value="" id="agree-check">
                                                    <label class="form-check-label agree-check-label" for="agree-check">
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-sm">
                                                <button type="submit" class="btn btn-admin w-100">Sign Up</a>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm">
