...
<body class="vb__layout--cardsShadow vb__layout--grayBackground vb__menuTop--dark">
  ...
  <div class="vb__auth__topbar">
    <div class="vb__auth__logoContainer">
      <div class="vb__auth__logoContainer__logo">
        <img src="/clearui/components/css/img/logo.svg" class="mr-2" alt="Clean UI" />
        <div class="vb__auth__logoContainer__name">FPB</div>
      </div>
    </div>
    <div class="d-none d-sm-block">
      <span class="mr-2">Don't have an account?</span>
      <a href="/register" class="font-size-16 vb__utils__link">
        Sign up
      </a>
    </div>
  </div>
  <div class="vb__auth__containerInner">
    <div class="text-center mb-5">
      <h1 class="mb-5 px-3">
        <strong>Welcome FBP</strong>
      </h1>
      <p class="mb-4">
        Easy To use
        <br />
        Esay access to your clients
      </p>
    </div>
    <div class="card vb__auth__boxContainer">
      ...
      <form novalidate method="POST" action="{{ route('register_response') }}">
          ...
          <div class="form-group mb-4">
                        <input name="name" id="last-name" value="{{ old('name') }}" type="text" class="form-control" placeholder="name" />
                        @error('name')
...
<div class="form-group mb-4">
    ...
    <div class="text-center pt-2 mb-auto">
      <span class="mr-2">Do have an account?</span>
  ...
  <div class="vb__footer__inner">
    <a href="#" target="_blank" rel="noopener noreferrer" class="vb__footer__logo">
