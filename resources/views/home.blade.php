...
<div class="row">
  ...
  <div class="card-body">
    <div class="pt-5 pb-5 pl-5 pr-5 text-center flex-grow-1">
      ...
      <div class="text-dark font-weight-bold font-size-36">{{$plan->name}}</div>
      <div class="text-dark font-weight-bold font-size-48 mb-3">
        $30 <span class="align-text-top font-size-28 text-gray-6">/mo</span>
      </div>
      ...
      @else
          <div class="text-center">
              ...
              <p> You can access the dashboard from here <a target="_blank" style="color:blue" href="{{route('leads')}}">Dashboard</a>
              </p>
          </div>
      @endif
    </div>
