...
@section('content')
  ...
  <div class="vb__breadcrumbs__path">
    ...
    <span>
      ...
      <script>
        ...
        <div class="text-uppercase">Today Groups</div>
      ...
      <script>
        ...
        <div class="text-uppercase">Yesterday Groups</div>
  ...
  <div class="card-header card-header-flex">
    ...
    <div class="d-flex flex-column justify-content-center">
      <a class="btn btn-primary" href="{{route('NewGroup')}}">New Group</a>
    </div>
    ...
    <table class="table table-hover nowrap stripe row-border order-column" id="example1">
      ...
      <tbody>
            ...
            <td style="Background-color:#f2f4f8">
              <a href="/groups/edit/{{$lead->id}}" class="btn btn-sm btn-light mr-2"
                ><i class="fe fe-edit mr-2"></i> View
                </a>
                <a href="/group/attachments/{{$lead->id}}" class="btn btn-sm btn-light mr-2"
                  ><i class="fe fe-edit mr-2"></i> View Attachments
                  </a>
              <a href="/groups/delete/{{$lead->id}}" class="btn btn-sm btn-light">
                <small
