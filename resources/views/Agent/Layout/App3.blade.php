...
<head>
  ...
  <link rel="stylesheet" type="text/css"
    href="/clearui/vendors/tempus-dominus-bs4/build/css/tempusdominus-bootstrap-4.min.css">
  ...
  <link rel="stylesheet" type="text/css" href="/clearui/vendors/font-feathericons/dist/feather.css">
  ...
  <script src="/clearui/vendors/bootstrap-show-password/dist/bootstrap-show-password.min.js"></script>
  ...
  <script src="/clearui/vendors/chartist-plugin-tooltips-updated/dist/chartist-plugin-tooltip.min.js"></script>
  ...
  <script src="/clearui/vendors/jqvmap/dist/jquery.vmap.js"></script>
  <script src="/clearui/vendors/jqvmap/dist/maps/jquery.vmap.usa.js" charset="utf-8"></script>

  <!-- VISUAL BUILDER MODULES-->
  <link rel="stylesheet" type="text/css" href="/clearui/components/css/vendors/style.css">
  <link rel="stylesheet" type="text/css" href="/clearui/components/css/core.css">
  <link rel="stylesheet" type="text/css" href="/clearui/components/css/colors.css">
  <link rel="stylesheet" type="text/css" href="/clearui/components/css/layout.css">
  <link rel="stylesheet" type="text/css" href="/clearui/components/css/measurements.css">
  <link rel="stylesheet" type="text/css" href="/clearui/components/css/utils.css">

  <link rel="stylesheet" type="text/css" href="/clearui/components/widgets/style.css">
  <link rel="stylesheet" type="text/css" href="/clearui/components/apps/style.css">
  <link rel="stylesheet" type="text/css" href="/clearui/components/ecommerce/style.css">
  <link rel="stylesheet" type="text/css" href="/clearui/components/dashboards/style.css">
  <link rel="stylesheet" type="text/css" href="/clearui/components/system/auth/style.css">

  <link rel="stylesheet" type="text/css" href="/clearui/components/layout/breadcrumbs/style.css">
  <link rel="stylesheet" type="text/css" href="/clearui/components/layout/footer/style.css">
  <link rel="stylesheet" type="text/css" href="/clearui/components/layout/menu-left/style.css">
  <link rel="stylesheet" type="text/css" href="/clearui/components/layout/menu-top/style.css">
  <link rel="stylesheet" type="text/css" href="/clearui/components/layout/sidebar/style.css">
  <link rel="stylesheet" type="text/css" href="/clearui/components/layout/support-chat/style.css">
  <link rel="stylesheet" type="text/css" href="/clearui/components/layout/topbar/style.css">

  <script src="/clearui/components/css/index.js"></script>
  <script src="/clearui/components/layout/menu-left/index.js"></script>
  <script src="/clearui/components/layout/menu-top/index.js"></script>
  <script src="/clearui/components/layout/sidebar/index.js"></script>
  <script src="/clearui/components/layout/support-chat/index.js"></script>
  <script src="/clearui/components/layout/topbar/index.js"></script>
...
<body class="vb__layout--cardsShadow vb__layout--grayBackground vb__layout--appMaxWidth">
      ...
      <ul class="vb__menuTop__navigation vb__menuTop__navigation--root">
        <!-- <li class="vb__menuTop__item vb__menuTop__submenu">
          ...
          <!-- <ul class="vb__menuTop__navigation">
            ...
            <li class="vb__menuTop__item">
              <a class="vb__menuTop__item__link" href="dashboards-beta.html">
                <span class="vb__menuTop__item__title">Dashboard Beta</span>
              </a>
            </li>
            <li class="vb__menuTop__item">
              <a class="vb__menuTop__item__link" href="dashboards-gamma.html">
                <span class="vb__menuTop__item__title">Dashboard Gamma</span>
              </a>
            </li>
            <li class="vb__menuTop__item">
              <a class="vb__menuTop__item__link" href="dashboards-crypto.html">
        ...
        <li class="vb__menuTop__item vb__menuTop__submenu">
          <span class="vb__menuTop__item__link">
            ...
            <i class="vb__menuTop__item__icon fe fe-user"></i>
          </span>
          <ul class="vb__menuTop__navigation">


            <li class="vb__menuTop__item">
              <a class="vb__menuTop__item__link" href="/leads">
                <span class="vb__menuTop__item__title">Leads</span>
                <i class="vb__menuTop__item__icon lnr lnr-database"></i>
              </a>
            </li>

            <li class="vb__menuTop__item">
              <a class="vb__menuTop__item__link" href="/accounts">
                <span class="vb__menuTop__item__title">Accounts</span>
                <i class="vb__menuTop__item__icon lnr lnr-users"></i>
              </a>
            </li>
            <li class="vb__menuTop__item">
        ...
        <li class="vb__menuTop__item vb__menuTop__submenu">
          <span class="vb__menuTop__item__link">
            <span class="vb__menuTop__item__title">Activities</span>
    ...
    <div class="vb__topbar__livesearch">
      ...
      <div class="container-fluid">
        <div class="vb__topbar__livesearch__wrapper">
          <input type="text" id="livesearch__input__inner" class="vb__topbar__livesearch__input"
            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="vb__topbar__livesearch__result__content">
                  <div class="vb__topbar__livesearch__result__thumb"
                    style="background-image: url('/clearui/components/css/img/content/photos/1.jpeg')">
                    #1
                  </div>
                ...
                <div class="vb__topbar__livesearch__result__content">
                  <div class="vb__topbar__livesearch__result__thumb"
                    style="background-image: url('/clearui/components/css/img/content/photos/2.jpeg')">
                    KF
                  </div>
                  <div class="vb__topbar__livesearch__result">
                    <div class="vb__topbar__livesearch__result__text">
                ...
                <div class="vb__topbar__livesearch__result__content">
                  <div class="vb__topbar__livesearch__result__thumb"
                    style="background-image: url('/clearui/components/css/img/content/photos/3.jpeg')">
                    GF
                  </div>
                  <div class="vb__topbar__livesearch__result">
                    <div class="vb__topbar__livesearch__result__text">
                ...
                <div class="vb__topbar__livesearch__result__content">
                  <div class="vb__topbar__livesearch__result__thumb"
                    style="background-image: url('/clearui/components/css/img/content/photos/4.jpeg')">
                    GF
                  </div>
                  <div class="vb__topbar__livesearch__result">
                    <div class="vb__topbar__livesearch__result__text">
...
<div class="card-body">
  ...
  <script>
    ...
    <div class="vb__footer__inner">
      <a href="https://visualbuilder.cloud" target="_blank" rel="noopener noreferrer" class="vb__footer__logo">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" version="1.1" height="24px" width="24px">
          <g>
            <path fill="#4b7cf3" strokeWidth="1" stroke="#4b7cf3"
              d="M12,10.9c-0.1,0-0.2,0-0.2-0.1L3.5,6.1C3.4,6,3.3,5.8,3.3,5.6c0-0.2,0.1-0.3,0.2-0.4l8.2-4.7c0.2-0.1,0.3-0.1,0.5,0      l8.2,4.7c0.2,0.1,0.2,0.3,0.2,0.4S20.6,6,20.5,6.1l-8.2,4.7C12.2,10.8,12.1,10.9,12,10.9z M4.8,5.6L12,9.8l7.2-4.2L12,1.5      L4.8,5.6z" />
        ...
        <strong className="mr-2">FBP</strong>
      </a>
      <br />
      <p class="mb-0">
        Copyright ©
