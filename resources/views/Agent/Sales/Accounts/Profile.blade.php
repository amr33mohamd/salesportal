...
<div class="card-body">
  <div class="d-flex flex-wrap flex-column align-items-center">
    <div class="vb__utils__avatar vb__utils__avatar--size64 mb-3">
      <img src="../../components/css/img/avatars/3.jpg" alt="Mary Stanform" />
    </div>
...
<div class="card-header card-header-flex flex-column">
  ...
  <div class="d-flex align-items-stretch mt-auto">
    <ul class="nav nav-tabs nav-tabs-line nav-tabs-line-bold nav-tabs-noborder nav-tabs-stretched">
      <li class="nav-item">
        <a class="nav-link active" onclick="correct_table()" href="#tab-wall-content" data-toggle="tab" aria-selected="true"
          id="tab-wall">Calls</a>
      </li>
      <li class="nav-item">
...
<div class="card-body">
  <div class="tab-content">
    ...
    <div class="tab-pane fade show active" id="tab-wall-content" role="tabpanel"
