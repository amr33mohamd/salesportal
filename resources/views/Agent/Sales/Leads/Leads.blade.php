...
<section class="card">
  <div class="card-header">
    <span class="cui-utils-title">
      <strong>Leads</strong>
      <a href="{{route('NewLead')}}" target="_blank" class="btn btn-sm btn-primary ml-2"
        >Add Lead <i class="icmn-plus ml-1"><!-- --></i></a
      >
    </span>
  </div>
  <div class="card-body">
...
<td>
                ...
                <td>
                  ...
                  <a href="/leads/edit/{{$lead->id}}" style="display:inline-block;width:50%">  <button class="btn btn-sm btn-primary ml-2"><img src="./assets/images/table-edit.svg"/></button></a>


                  <a  href="/leads/delete/{{$lead->id}}"  style="display:inline-block;width:50%;text-align: right;color: red;">X</a>
                </td>
              @foreach($fields as $field)
