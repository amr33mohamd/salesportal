...
<span>
<span class="vb__breadcrumbs__arrow"></span>
<strong class="vb__breadcrumbs__current">Item</strong>
</span>
</div>
</div>
...
<!-- START: forms/basic-forms-elements -->
          ...
          <!-- Vertical Form -->
          <form method="post" action="@if($type == 'add') {{route('NewItemAction')}} @else /items/edit/action/{{$lead->id}} @endif"  enctype="multipart/form-data">
            @csrf
          ...
          <div class="form-row">
            ...
            <div class="form-row">
              <div class="form-group col-md-4">
                        <label for="lead-p" class="form-field__label">Price</label>
                        <input  name="price" id="lead-p" type="number"                     class="form-control"

                               placeholder="Price" value="{{old('price',($lead->price) ? $lead->price :null)}}"  required>
                    </div>
