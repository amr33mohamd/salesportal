                            ...
                            <div class="tab-content " id="myTabContent">
                                ...
                                <div class="tab-pane fade attachment-btn show " id="attachments-assign" role="tabpanel"
                                                                        ...
                                                                        <div class="row mx-0">
                                                                            <div class="col-lg px-2">
                                                                                <div class="form-field">
                                                                                  <form action="/opportunity/add/attachment/{{$opportunity->id}}" method="post">
                                                                                    @csrf
                                    ...
                                    <div class="row my-3 attachment-row">
                                      @if($opportunity->assiegned_attachments->count() == 0)
                                      <p>No Attachments assiegned</p>
                                      @else
                                      @foreach($opportunity->assiegned_attachments as $attachment)
                                              ...
                                              <div class="social-box-detail p-3">
                                                  <div class="row">
                                                      <div class="col">
                                                          ...
                                                          <p><a href="/opportunity/edit/assign-attachment/{{$attachment->id}}"  >Delete</a></p>
                                                      </div>
